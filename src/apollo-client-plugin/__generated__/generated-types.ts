...
export type AllFilmsWithVariablesQueryVariables = Exact<{
  first: Scalars['Int'];
}>;


export type AllFilmsWithVariablesQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', edges?: Array<{ __typename?: 'FilmsEdge', node?: { __typename?: 'Film', id: string, title?: string | null, releaseDate?: string | null, producers?: Array<string | null> | null, director?: string | null } | null } | null> | null } | null };

export type FilmItemFragment = { __typename?: 'Film', id: string, title?: string | null, releaseDate?: string | null, producers?: Array<string | null> | null, director?: string | null };

export const FilmItemFragmentDoc = gql`
  ...
  director
    ...
    `;
export const AllFilmsWithVariablesDocument = gql`
...
/**
 * __useAllFilmsWithVariablesQuery__
 *
 * To run a query within a React component, call `useAllFilmsWithVariablesQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllFilmsWithVariablesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllFilmsWithVariablesQuery({
 *   variables: {
 *      first: // value for 'first'
 *   },
 * });
 */
export function useAllFilmsWithVariablesQuery(baseOptions: Apollo.QueryHookOptions<AllFilmsWithVariablesQuery, AllFilmsWithVariablesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllFilmsWithVariablesQuery, AllFilmsWithVariablesQueryVariables>(AllFilmsWithVariablesDocument, options);
      }
export function useAllFilmsWithVariablesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllFilmsWithVariablesQuery, AllFilmsWithVariablesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllFilmsWithVariablesQuery, AllFilmsWithVariablesQueryVariables>(AllFilmsWithVariablesDocument, options);
        }
export type AllFilmsWithVariablesQueryHookResult = ReturnType<typeof useAllFilmsWithVariablesQuery>;
export type AllFilmsWithVariablesLazyQueryHookResult = ReturnType<typeof useAllFilmsWithVariablesLazyQuery>;
export type AllFilmsWithVariablesQueryResult = Apollo.QueryResult<AllFilmsWithVariablesQuery, AllFilmsWithVariablesQueryVariables>;