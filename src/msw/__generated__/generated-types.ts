 ...
 * @example
 * mockAllFilmsWithVariablesQuery((req, res, ctx) => {
 ...
 * })
 */
export const mockAllFilmsWithVariablesQuery = (resolver: ResponseResolver<GraphQLRequest<AllFilmsWithVariablesQueryVariables>, GraphQLContext<AllFilmsWithVariablesQuery>, any>) =>
  graphql.query<AllFilmsWithVariablesQuery, AllFilmsWithVariablesQueryVariables>(
    'allFilmsWithVariables',
    resolver
  )
